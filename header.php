...
<style>
/* Adjust the height of the navbar by reducing padding */
.navbar {
    padding-top: 5px;  /* Top padding reduce */
    padding-bottom: 5px;  /* Bottom padding reduce */
}

/* Navbar links font size adjustment */
.navbar-nav .nav-link {
    font-size: 14px;  /* Font size reduce for compact look */
    padding-left: 10px;  /* Left padding reduce */
    padding-right: 10px;  /* Right padding reduce */
}

/* Adjust navbar items (make sure spacing is balanced) */
.navbar-nav .nav-item {
    margin-left: 10px;  /* Adjust margin between items */
    margin-right: 10px;  /* Adjust margin between items */
}

/* Adjust the navbar-toggler (hamburger icon) size */
.navbar-toggler {
    padding: 8px 15px;  /* Reduce the toggler padding size */
}
            ...
            <div class="d-flex justify-content-between">
                <div class="top-info ps-2">
                    <small class="me-3"><i class="fas fa-map-marker-alt me-2 text-secondary"></i> <a href="#"
                            class="text-white">Nankana Sahib , Pakistan</a></small>
                    <small class="me-3"><i class="fas fa-envelope me-2 text-secondary"></i><a href="#"
                            class="text-white">aminabatool1511@gmail.com</a></small>
                </div>
        ...
        <div class="container px-0">
            <nav class="navbar navbar-light bg-white navbar-expand-xl">
                <a href="index.php" class="navbar-brand">
                    <h1 class="text-primary display-6">SHOE HUB</h1>
                </a>
